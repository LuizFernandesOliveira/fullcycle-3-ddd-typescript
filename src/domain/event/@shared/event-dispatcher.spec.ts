...
import SendEmailWhenProductIsCreatedHandler from "../produc/handler/send-email-when-product-is-created.handler";
import ProductCreatedEvent from "../produc/product-created.event";
